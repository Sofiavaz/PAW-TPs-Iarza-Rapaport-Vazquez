...
class TurnosController extends Controller
{
    ...
    {
    	var_dump(App::get('coloresPelo'));
    	exit(0);
    	//$coloresPelo = App::get('coloresPelo');
    	return view('turnos.crear', compact('coloresPelo'));
    }
	...
	public function show() {
		if (isset($_GET['id']) && !is_null($_GET['id'])){
			...
			$edit = false;
			return view('ficha-turno', compact('turno','coloresPelo','edit'));
		}
	...
	public function edit() {
		if (isset($_GET['id']) && !is_null($_GET['id'])){
			...
			return view('edit-turno', compact('turno','coloresPelo', 'edit'));
		}
